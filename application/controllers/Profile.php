...
class Profile extends CI_Controller {
    ...
    // public function transaction_paket(){
    //     $data['title'] = 'Transaksi - ' . $this->Settings_model->general()["app_name"];
    //     $data['css'] = 'profile';
    //     $data['transaction_paket'] = $this->User_model->getOrderPaket();
    //     $this->load->view('templates/header', $data);
    //     $this->load->view('templates/navbar');
    //     $this->load->view('profile/order_paket', $data);
    //     $this->load->view('templates/footerv2');
    // }
    ...
    //     $data['ord'] = $this->User_model->getOrderPaketByInvoice($id);
    //     if(!$data['ord']){
    //         redirect(base_url() . 'profile/transaction');
    //     }
    //     $data['title'] = 'Detail Pesanan - ' . $this->Settings_model->general()["app_name"];
    //     $data['css'] = 'profile';
    //     $data['paket_order'] = $this->User_model->getPaketByInvoice($id);
    //     $this->load->view('templates/header', $data);
    //     $this->load->view('templates/navbar');
    //     $this->load->view('profile/detail_order_paket', $data);
    //     $this->load->view('templates/footerv2');
    // }
