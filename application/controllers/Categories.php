...
class Categories extends CI_Controller {
    ...
    $cat = $this->Categories_model->getIdCategoryBySlug($c);
		...
		if($ob != NULL){
			...
			// $data['paket'] = $this->Fotografi_model->getAllPaketByCategoryPrice($cat, $minprice, $maxprice);
