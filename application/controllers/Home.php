...
class Home extends CI_Controller
{
	...
	public function index()
	{
		...
		// $data['getPromoPaket'] = $this->Promo_model->getPromoPaketLimit();
		$data['recent'] = $this->Products_model->getProductsLimit();
		// $data['recent_paket'] = $this->Fotografi_model->getPaketLimit();
		$data['best'] = $this->Products_model->getBestProductsLimit();
		// $data['best_paket'] = $this->Fotografi_model->getBestPaketLimit();
		$data['allProducts'] = $this->db->get('products');
		// $data['allPaket'] = $this->db->get('paket');
