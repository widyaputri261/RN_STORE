<div class="container mt-5 mb-5">
    <div class="row">
        <div class="col-md-7">
            ...
            <hr>
            <?php if ($metod == 'cod') { ?>
                <p>Anda menggunakan metode COD/Cash On Delivery, silahkan hubungi kami melalui WhatsApp dengan mengklik tombol dibawah ini</p>
                <a href="https://wa.me/<?= $this->Settings_model->general()["whatsappv2"]; ?>?text=Halo kak, saya membeli produk di <?= $this->Settings_model->general()["app_name"]; ?> menggunakan metode COD dengan Order ID <?= $invoice_id['invoice']; ?>" class="btn btn-sm btn-success" target="_blank"> Hubungi WhatsApp</a>
            <?php } else { ?>
