...
<footer>
            ...
            <div class="form">
                <form action="<?= base_url(); ?>subscribe-email" method="post">
                    <div class="col-md-9">
                        ...
                        <button type="submit" style="width: 100px; height: 48px;">Subscribe</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="copyright" style="background-color: <?= $this->Settings_model->general()["navbar_color"]; ?> !important">
        <p class="mb-0">Copyright &copy;<span id="footer-cr-years"></span> <?= $this->Settings_model->general()["app_name"]; ?> by Widya Putri.</p>
    </div>
</footer>
