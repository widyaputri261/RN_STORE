    ...
    <div class="core">
        ...
        <form action="<?= base_url(); ?>profile/change-password" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="password" name="oldpassword" class="form-control" id="oldpassword" autocomplete="off" required>
                <small class="form-text text-danger pl-1"><?php echo form_error('oldpassword'); ?></small>
            </div>
            <div class="form-group">
                <label for="newpassword">Password Baru</label>
                <input type="password" name="newpassword" class="form-control" id="newpassword" autocomplete="off" required>
                <small class="form-text text-danger pl-1"><?php echo form_error('newpassword'); ?></small>
            </div>
            <div class="form-group">
                <label for="confirmpassword">Konfirmasi Password Baru</label>
                <input type="password" name="confirmpassword" class="form-control" id="confirmpassword" autocomplete="off" required>
