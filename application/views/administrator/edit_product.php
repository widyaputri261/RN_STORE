				...
				<div class="form-row">
					<div class="col-md-4">
						<div class="form-group">
							...
							<input type="number" class="form-control" id="price_buy" name="price_buy" placeholder="Harga Beli" autocomplete="off" required value="<?= $product['price_buy']; ?>" />
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<input type="number" class="form-control" id="price" name="price" placeholder="Harga Jual" autocomplete="off" required value="<?= $product['price']; ?>" />
							<small id="priceHelp" class="form-text text-muted">Isikan tanpa tanda pemisah. Contoh pengisian 300000</small>
						</div>
					</div>
					<div class="col-md-4">
