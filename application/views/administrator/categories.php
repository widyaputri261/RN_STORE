                            ...
                            <?php foreach ($getCategories->result_array() as $data) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= base_url() ?>administrator/deleteCategory/<?= $data['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus kategori ini? Semua produk yang terkait akan ikut terhapus')"><i class="fa fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
