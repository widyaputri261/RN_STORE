            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" autocomplete="off" required value="<?= $sosmed['name']; ?>">
                            <small class="text-muted">Contoh: Facebook, Twitter</small>
                        </div>
                        <div class="form-group">
                            <label for="icon">Icon Sosmed</label>
                            <input type="text" class="form-control" id="icon" name="icon" autocomplete="off" required value="<?= $sosmed['icon']?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="link" name="link" autocomplete="off" required value="<?= $sosmed['link']?>">
