...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="<?= base_url(); ?>administrator/lokasi/<?= $lokasi['id'] ?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="regency">Kabupaten atau Kota</label>
                    <select name="regency" id="regency" class="form-control" required>
                        <option value="<?$lokasi['regency']?>"><?= $lokasi['regency'] ?></option>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="price" name="price" autocomplete="off" required value="<?= $lokasi['price']; ?>">
