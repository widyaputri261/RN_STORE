...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <a href="<?= base_url(); ?>administrator/products" class="btn btn-info"><i class="fa fa-chevron-circle-left"></i> Kembali</a>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-7">
                    <div class="card-body">
                        ...
                        <table>
                            <tr>
                                <td>Harga Beli</td>
                                <td>: Rp <?= str_replace(",", ".", number_format($product['price_buy'])); ?></td>
                            </tr>
                            <tr>
                                <td>Kategori</td>
                                <td>: <?= $product['name'] ?></td>
