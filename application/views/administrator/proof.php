                        ...
                        <tbody class="data-content">
                            ...
                            <?php foreach ($proof->result_array() as $data) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url() ?>administrator/confirm_proof/<?= $data['invoice']; ?>" class="btn btn-sm btn-info" onclick="return confirm('Yakin sudah menerima pembayaran dan ingin mengonfirmasi pesanan?');"><i class="fa fa-check-circle"></i> Selesai</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
