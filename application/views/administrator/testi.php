...
<div class="container-fluid mb-5">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#addTestimoni">Tambah</a>
        </div>
        <div class="card-body">
                            ...
                            <?php foreach ($testi->result_array() as $data) : ?>
                                <tr>
                                    ...
                                    <td style="width: 100px;">
                                        ...
                                        <a href="<?= base_url() ;?>administrator/delete_testimonial/<?= $data['id']; ?>" onclick="return confirm('Yakin ingin menghapus testimoni ini?')" class="btn btn-sm btn-danger"><i class="fa fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
...
<!-- Modal Add Testimoni -->
<div class="modal fade" id="addTestimoni" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url(); ?>administrator/testimonials" method="post" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="btn btn-primary" id="btnAddTestimoni">
                        Tambahkan
                    </button>
                </form>
            </div>
