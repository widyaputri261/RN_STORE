...
$route['administrator/paket/search'] = 'administrator/search_paket';
$route['administrator/paket/add'] = 'administrator/add_paket';
$route['administrator/paket/add-img/(:num)'] = 'administrator/add_img_paket/$1';
$route['administrator/paket/(:num)/edit'] = 'administrator/edit_paket/$1';
$route['administrator/pembelian'] = 'administrator/pembelian';
$route['administrator/pembelian/add'] = 'administrator/add_pembelian';
$route['administrator/pembelian/del/(:num)/(:num)'] = 'administrator/del_pembelian';
$route['administrator/lokasi/add'] = 'administrator/add_lokasi';
$route['administrator/lokasi/(:num)'] = 'administrator/edit_lokasi/$1';
$route['administrator/pesanpaket'] = 'administrator/orders_paket';
$route['administrator/pesanpaket/add'] = 'administrator/add_pesan_paket';
$route['administrator/pesanpaket/(:num)'] = 'administrator/detail_order_paket/$1';
